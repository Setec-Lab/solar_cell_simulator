...
def writeInNotepad(time, counter, vc, ic, rc, vm, im, rm):
    if im != 0 and ic !=0 :
        ...
        file.write("\nskipped because ic or im == 0")
        print("skipped because ic or im == 0")
...
Carga.fijar_funcion("CURR")
Carga.encender_carga()
Carga.fijar_corriente(1.56)
...
#open a file
file = open("SAS_v3_Current_Test.txt", "w")
...
while counter <= 100:
    ...
    #up resistance
    loadCurrent -= 0.0156
    print(Carga.fijar_corriente(loadCurrent))
